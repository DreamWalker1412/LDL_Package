function [resultSingle,resultAll,preLabels] = ldlAdaboost(trainFeatures,trainLabels,testFeatures,testLabels,boostTimes,nboot,factor)
if nargin == 4
    boostTimes = 5;
    nboot = 1;
    factor = 1.0;
...
% Adaboosting
    ...
    for i = 1:boostTimes 
        ...
        if i == 1
            [weights{i},~] = bfgsLdlTrain(item,bootTrainFeatures{i},bootTrainLabels{i});
        else
            [weights{i},~] = bfgsLdlTrain(weights{i-1},bootTrainFeatures{i},bootTrainLabels{i});
        end
