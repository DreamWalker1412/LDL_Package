function [resultSingle,resultAll] = ldlAdaboost_lc(trainFeatures,trainLabels,testFeatures,testLabels,boostTimes,nboot,factor)
if nargin == 4
    boostTimes = 5;
    nboot = 1;
    factor = 1.0;
...
% Adaboosting
    ...
    for i = 1:boostTimes 
        ...
        if i == 1
            [weights{i},~] = lcLdlTrain(item,bootTrainFeatures{i},bootTrainLabels{i});
        else
            [weights{i},~] = lcLdlTrain(weights{i-1},bootTrainFeatures{i},bootTrainLabels{i});
        end
