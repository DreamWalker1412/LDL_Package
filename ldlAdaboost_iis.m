function [resultSingle,resultAll] = ldlAdaboost_iis(trainFeatures,trainLabels,testFeatures,testLabels,boostTimes,nboot,factor)
if nargin == 4
    boostTimes = 5;
    nboot = 1;
    factor = 1.0;
...
% Adaboosting
    ...
    for i = 1:boostTimes 
        ...
        if i == 1
            weights{i} = iislldTrain(bootTrainFeatures{i},bootTrainLabels{i});
        else
            weights{i} = iislldTrain(bootTrainFeatures{i},bootTrainLabels{i},weights{i-1});
        end
